...
use seija_core::{bevy_ecs::prelude::{ResMut, Query}, time::Time};
use crate::{RuntimeSkeleton, AnimationControl, AnimationSet, Skeleton};

pub fn update_skeleton_system(time:Res<Time>,skeletons:Res<Assets<Skeleton>>,mut rtskeletons:ResMut<Assets<RuntimeSkeleton>>,anims:Res<Assets<AnimationSet>>,mut query:Query<(Entity,&mut AnimationControl)>,) {
